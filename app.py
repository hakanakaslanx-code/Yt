...
try:
    ...
    from uploader import upload_video, generate_seo_metadata, set_thumbnail, get_or_create_playlist, add_video_to_playlist, update_live_broadcast_title, get_or_create_live_stream_key
...
def api_status():
    ...
    return jsonify({"tasks": out, "stats": stats, "yt_connected": is_connected()})
